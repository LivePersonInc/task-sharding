...
class TaskSharding extends Events {
    ...
    /**
     * Returns true if and only if the selfNode is the owner for the given task.
     * (Task ids not previously added will return false.)
    ...
    /**
     * Returns the owner name for the task with the given id.
     * (Task ids not previously added will return undefined.)
     * @param id
     * @return {string}
     */
    getOwner(id) {
...
const TASK_ASSIGNED_EVENT = TaskSharding.TASK_ASSIGNED_EVENT = 'task-assigned';
const TASK_REVOKED_EVENT = TaskSharding.TASK_REVOKED_EVENT = 'task-revoked';
