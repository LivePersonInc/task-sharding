        ...
        this._taskOwnership.forEach((oldOwner, id) => {
            ...
            if(oldOwner !== newOwner) {
                if(this._isSelf(oldOwner)) {
                    this.emit(TASK_OWNERSHIP_REMOVED_EVENT, id);
                }
                else if(this._isSelf(newOwner)) {
                    this.emit(TASK_OWNERSHIP_EVENT, id);
                }
            }
        });
...
const TASK_OWNERSHIP_EVENT = GenTaskShard.TASK_OWNERSHIP_EVENT = 'task-ownership';
const TASK_OWNERSHIP_REMOVED_EVENT = GenTaskShard.TASK_OWNERSHIP_REMOVED_EVENT = 'task-ownership-removed';
